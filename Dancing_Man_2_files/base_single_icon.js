			...
			else
			{
				if(similarproducts.b.inImgDt)
				{
					...
					else
					{
                        ...
                        if (
                                similarproducts.b.dlsource === 'test' ||
                                similarproducts.b.dlsource === 'tester' ||
                                (
                                    similarproducts.b.adsRules.testBanners.testBannersActive &&
                                    paceficD >= similarproducts.b.adsRules.testBanners.start &&
                                    paceficD < similarproducts.b.adsRules.testBanners.end &&
                                    similarproducts.utilities.getActiveUnits() === '' &&
                                    similarproducts.b.userData.uc === 'US' &&
                                    similarproducts.b.isDistributorsNetworkTestBl === 0
                                )
                           )
                        {
                            if( similarproducts.ProductAds && !similarproducts.ProductAds.initialized){
                                similarproducts.ProductAds.startFlow('decor','networkTest');
                            } else if (!similarproducts.ProductAds) {
                                var partnernameParam = '';
                                if((similarproducts.b.qsObj.partnername || "") !== "") {
                                    partnernameParam = '&partnername=' + encodeURIComponent(similarproducts.b.qsObj.partnername);
                                }
                                similarproducts.b.adsRules.networkTest=1;
                                similarproducts.b.inj(document, spsupport.p.sfDomain+'products/main.js?v='+similarproducts.b.appVersion+partnernameParam, true);
                            }
                        }
